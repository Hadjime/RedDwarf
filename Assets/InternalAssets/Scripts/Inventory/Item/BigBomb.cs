	...
	public class BigBomb : MonoBehaviour
	{
		...
		public void BabahOnce()
		{
			if (!once)
			{
				...
				Instantiate(cellExplosion, transform.position + Vector3.down * 3, Quaternion.identity);
				...
				Instantiate(cellExplosion, transform.position + Vector3.up * 3, Quaternion.identity);
				...
				Instantiate(cellExplosion, transform.position + Vector3.left * 3, Quaternion.identity);
				...
				Instantiate(cellExplosion, transform.position + Vector3.right * 3, Quaternion.identity);
