...
namespace Lean.Localization
{
	...
	[AddComponentMenu(LeanLocalization.ComponentPathPrefix + "Localized Dropdown MeshPro")]
	public class LeanLocalizedDropdownMeshPro : MonoBehaviour, ILocalizationHandler
	{
		...
		public void UpdateLocalization()
		{
			...
			if (options != null)
			{
				for (var i = 0; i < options.Count; i++)
				{
					...
					var spriteTranslation = LeanLocalization.GetTranslation(option.SpriteTranslationName);
